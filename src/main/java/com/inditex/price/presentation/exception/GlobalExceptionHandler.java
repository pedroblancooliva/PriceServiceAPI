 ...
 * Centraliza el manejo de errores siguiendo principios de arquitectura hexagonal
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMissingParameter(MissingServletRequestParameterException ex) {
        ...
        ErrorResponse error = new ErrorResponse(HttpStatus.BAD_REQUEST.value(), "Parámetro faltante", "El parámetro '" + ex.getParameterName() + "' es obligatorio");
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
        ...
        ErrorResponse error = new ErrorResponse(HttpStatus.BAD_REQUEST.value(), "Formato de parámetro inválido", "El parámetro '" + ex.getName() + "' tiene un formato inválido");
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(error);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGenericError(Exception ex) {
        ...
        ErrorResponse error = new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Error interno del servidor", "Ha ocurrido un error inesperado");
