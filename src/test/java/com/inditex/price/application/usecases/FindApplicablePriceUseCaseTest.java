...
class FindApplicablePriceUseCaseTest {
        ...
        void shouldExecuteSuccessfullyWhenPriceFound() {
                ...
                when(priceRepository.findApplicablePrices(any(ProductId.class), any(BrandId.class),
                                eq(applicationDate)))
                ...
                verify(priceRepository).findApplicablePrices(any(ProductId.class), any(BrandId.class),
                                eq(applicationDate));
